...
public class CreateRandomVacancies {
    ...
    private final List<String> descriptions = List.of("1. Bachelor's degree in Computer Science, Information Technology, or a related field.\n" +
    ...
    private final List<String> aboutProjectList = List.of("Our company works with startups - develop launch and improve them with modern technologies.",
    ...
    private final List<String> expectedList = List.of("Python", "HTML5", "JavaScript", "CSS", "PHP", "SQL", "C++", "Ruby", ".NET",
    ...
    private final List<String> jobPOsitions = List.of("Chief Architect", "Software Architect",
